...
@section('title', 'Outdoor Products – Admin Panel')
@section('content')

<div class="panel-page-header">
    <div>
        <h1 class="panel-page-title">Outdoor Products</h1>
        <p class="panel-page-sub">Create and manage all outdoor product listings</p>
    </div>
