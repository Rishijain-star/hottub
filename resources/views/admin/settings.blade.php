...
<div class="panel-page-header">
    <div>
        <h1 class="panel-page-title">Homepage images</h1>
        <p class="panel-page-sub">Upload multiple hero images and set their display order. The homepage hero uses them in that order as a slider.</p>
    </div>
</div>
...
<div class="card">
    <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-bottom:1.2rem;">
            <label class="form-label">Upload Hero Images (Multiple)</label>
        ...
        @if(!empty($homepageCtaImage))
            <div class="form-group" style="margin-bottom:1.2rem;">
                <label class="form-label">Current CTA Image</label>
        ...
        @if(count($heroImages))
            <div class="form-group" style="margin-bottom:1.2rem;">
                <label class="form-label">Current Hero Images (Set Order)</label>
                    ...
                    @foreach($heroImages as $idx => $img)
                        <div style="display:grid;grid-template-columns:120px 1fr auto auto;gap:.75rem;align-items:center;border:1px solid rgb(44, 45, 45);border-radius:10px;padding:.7rem;">
                            ...
                            <div style="min-width:110px;">
                                <label class="text-xs text-muted" style="display:block;margin-bottom:.2rem;">Order</label>
        ...
        <div style="margin-top:2rem;padding-top:1.2rem;border-top:1px solid rgb(44, 45, 45);">
            <h2 class="panel-page-title" style="font-size:1.1rem;margin-bottom:.25rem;">Business Details</h2>
            ...
            <div class="grid grid--2" style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem;">
                ...
                <div class="form-group">
                    <label class="form-label">FCA Number</label>
        ...
        {{-- ── Social Media Links ──────────────────────────────────── --}}
        <div style="margin-top:2rem;padding-top:1.2rem;border-top:1px solid rgb(44, 45, 45);">
            <h2 class="panel-page-title" style="font-size:1.1rem;margin-bottom:.25rem;">Social Media Links</h2>
