...
@section('title', __('panel.admin.pages.hot_tubs_edit.title') . ' – Admin Panel')
@section('content')
<div class="panel-page-header">
    <div>
        <h1 class="panel-page-title">{{ __('panel.admin.pages.hot_tubs_edit.title') }}</h1>
        <p class="panel-page-sub">{{ $item->brand }} — {{ $item->model }}</p>
    </div>
    <a href="{{ route('admin.hot-tubs.index') }}" class="btn">{{ __('panel.admin.common.back') }}</a>
</div>
