...
@section('title', __('panel.overview.title').' - '.__('panel.dealer_title'))
@section('styles')
...
<div class="dealer-overview-split" style="margin-top:1.5rem">
<div>
<div class="card">
            ...
            @forelse($recentRequests as $request)
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <a href="{{ route('dealer.service-requests') }}" class="btn btn--ghost btn--sm">{{ __('panel.common.view') }}</a>
                        @endif
                    </td>
                </tr>
            @empty
...
<aside class="card dealer-overview-tasks" style="margin-top:0">
    ...
    <div id="dashboardTasksActions" class="d-flex justify-content-center mt-3" style="gap:0.5rem">
        <button type="button" class="btn btn--outline btn--sm" id="seeMoreDashboardTasks">{{ __('panel.overview.see_more') }}</button>
        <button type="button" class="btn btn--outline btn--sm" id="seeLessDashboardTasks" style="display:none">{{ __('panel.overview.see_less') }}</button>
    </div>
    @else
