...
@section('title', 'Accounting & Invoices – Dealer Panel')
@section('content')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="white-space:nowrap;">
                    <a href="{{ route('dealer.invoice', $inv->invoice_number) }}" class="text-teal fw-700">View</a>
                    <span class="text-muted" style="margin:0 6px;">|</span>
                    <a href="{{ route('dealer.invoice.download', $inv->invoice_number) }}" class="text-teal fw-700">Download</a>
                </td>
            </tr>
            @empty
            <tr>
