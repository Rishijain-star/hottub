...
@section('title', __('panel.quotes.title', ['count' => $items->count()]).' - '.__('panel.manufacturer_title'))
@section('content')
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ trans_choice('panel.common.manufacturers_purchased', $it->purchases->count(), ['count' => $it->purchases->count()]) }}</td>
                <td>
