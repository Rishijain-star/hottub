...
@section('title', 'Maintenance Packages – Manufacturer Panel')
@section('content')
<style>
    .pkg-card {
        position: relative;
    ...
    <div class="pkg-card">
        <div class="pkg-header">
            ...
            <div style="display:flex; gap:8px;">
                ...
                <form method="POST" action="{{ route('manufacturer.maintenance-packages.destroy', $pkg) }}" onsubmit="event.preventDefault(); showConfirmationModal(this, 'Delete Package?', 'Are you sure you want to delete this package?');">
                    @csrf @method('DELETE')
