...
function renderConversationList() {
    ...
    if (!allConversations || allConversations.length === 0) {
        listEl.innerHTML = '<div class="chat-conv-empty">No conversations yet.</div>';
        return;
    }
...
function openConversationFromQuery() {
    ...
    if (!id) return;
    fetch('{{ route("manufacturer.api.conversations") }}')
